...
import { Eye, EyeOff, BookOpen, User, Mail, Lock, Sparkles, LogIn } from 'lucide-react';
      ...
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="text-center py-8 px-6 bg-gradient-to-r from-purple-600/30 to-blue-600/30">
            ...
            <p className="text-purple-200">Create your EBook Library account</p>
          </div>
          ...
          <div className="p-6">
            ...
            >
              ...
              <motion.button
                ...
                whileTap="tap"
                type="submit"
                disabled={loading || (registerForm.password !== registerForm.password_confirmation)}
